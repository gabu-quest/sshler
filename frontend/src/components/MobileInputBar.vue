...
<!-- Unscoped light-mode overrides — avoids Vite/Vue :global() build bug -->
<style>
[data-theme="light"] .mobile-input-bar {
  background: var(--surface);
  border-top: 1px solid var(--stroke);
}

[data-theme="light"] .quick-key {
...
[data-theme="light"] .smart-input {
  color: var(--text);
}

[data-theme="light"] .smart-input::placeholder {
  color: var(--muted);
}
...
[data-theme="light"] .legend-header {
  color: var(--text);
