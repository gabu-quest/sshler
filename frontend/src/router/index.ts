...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      meta: {
        title: "Progress",
        description: "Manage global progress bar subscriptions",
      },
    },
    {
      path: "/claude",
      ...
      meta: {
        title: "Claude",
        description: "Resume Claude Code sessions in a terminal",
      },
    },
    {
      path: "/diff",
      ...
      meta: {
        title: "Diff",
        description: "Compare files across boxes, repos, and refs",
      },
    },
    {
      path: "/diff/n/:id",
      ...
      meta: {
        title: "Diff",
        description: "Shared diff notebook",
      },
    },
    {
      path: "/settings",
...
// Handle navigation errors gracefully — especially stale chunk imports after deploys
