...
from .pdf import get_router as pdf_router
from .ping import get_router as ping_router
from .progress import get_router as progress_router
...
from .stats_stream import get_router as stats_stream_router
from .terminal import get_router as terminal_router
from .transfer import get_router as transfer_router
...
def create_api_router(deps: APIDependencies) -> APIRouter:
    ...
    api_router.include_router(claude_sessions_router(deps))
    api_router.include_router(diff_router(deps))
    api_router.include_router(files_router(deps))
    api_router.include_router(git_router(deps))
    api_router.include_router(grep_router(deps))
    api_router.include_router(pdf_router(deps))
    api_router.include_router(ping_router(deps))
    api_router.include_router(progress_router(deps))
    ...
    api_router.include_router(stats_stream_router(deps))
    api_router.include_router(terminal_router(deps))
    api_router.include_router(transfer_router(deps))
